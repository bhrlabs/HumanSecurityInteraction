...
var _pbg = isPBG()?"_pbg":"";
if(isPBG()) {
    __sonimg="signon_pbg.html";
    __soffimg="signoff_pbg.html";
}
if(typeof(_f)=='undefined') _f='NO';
...
var branding_sc_p3;
//Changes are made to this function for Session Timeout issue with respect to INC0020792757
    ...
    if (branding_sc_p3=="BBUILDER"){
       ...
       $jq(window).on('beforeunload', function() { 
              if(typeof(jQuery(window).data('onbeforeunload')) != 'undefined') { 
                    jQuery(window).data('onbeforeunload') = null; 
              } 
        });
...
var params = requestURL.split("https://online.citi.com/");
...
{  
 ...
 $('#ficoScoreLink').on('click',function(){
	var s=s_gi(s_account);
	if (typeof s!== 'undefined') {
	s.linkTrackVars = 'eVar20,eVar38';
	s.eVar38 = s.pageName;
	s.eVar20= "View your FICO Score";
...
function POSSpeedBumpLaunchTimeTrade(linkUrl) {

    if(linkUrl === 'https://www.timetrade.com/'){

        var speedBumpUrl = '/US/JRS/portal/template.do?ID=TimeTradeOnlineBranchAppointment&sourceID=1&landingURL='+'https://www.ttdemoui.timetradesystems.com';
