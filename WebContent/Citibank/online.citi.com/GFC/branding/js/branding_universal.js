...
var renderSearchControls = function() {
	if (document.getElementById('searchWrapper')) {	
	   if(typeof cbolURL != 'undefined') 
   google.search.cse.element.render( 
   { 
     div: "searchWrapper", 
     tag: 'searchbox-only', 
     gname: 'hkgcbSearch', 
     attributes: {resultsUrl: cbolURL+'/US/JRS/globalsearch/Search.do'} 
   }); 
 else 
	google.search.cse.element.render(
		{
	...
	if (document.getElementById('resultsDiv')) {
		...
		newButton.setAttribute("onclick", "javascript:gsearch2();scEventL()");
