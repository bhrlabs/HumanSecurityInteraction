var lpMTagConfig=lpMTagConfig||{};lpMTagConfig.vars=lpMTagConfig.vars||[];lpMTagConfig.dynButton=lpMTagConfig.dynButton||[];lpMTagConfig.lpProtocol=document.location.toString().indexOf("BrowserWarning.html")==0?"https":"http";lpMTagConfig.pageStartTime=(new Date).getTime();if(!lpMTagConfig.pluginsLoaded)lpMTagConfig.pluginsLoaded=!1;
...
lpMTagConfig.lpTagSrv = lpMTagConfig.lpTagSrv || "chat.online.citi.com";
lpMTagConfig.lpServer = lpMTagConfig.lpServer || "chat.online.citi.com";
lpMTagConfig.lpNumber = lpMTagConfig.lpNumber || "43414585"; // NOTE this will change based on test or Production environment.
